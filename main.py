...
# Load terrain tiles
grass_1_tile = loader.load_image_frames('.\\Asset\\Terrain\\grass-fall.png', None, 100, 100)[0]
grass_2_tile = loader.load_image_frames('.\\Asset\\Terrain\\grass-spring.png', None, 100, 100)[0]
grass_3_tile = loader.load_image_frames('.\\Asset\\Terrain\\grass-summer.png', None, 100, 100)[0]
grass_4_tile = loader.load_image_frames('.\\Asset\\Terrain\\grass-winter.png', None, 100, 100)[0]
